...
<details>
  ...
  <p>Over 18 holes of disc golf in March and April, Amira, Steve and I have been keeping our scores</p>
  ...
  <code>
    ...
    # new cell
    april_score_frame = pd.DataFrame(march_dict_scorecard, index=range(1, 19))
    april_score_frame
  </code>
</details>
<br>
